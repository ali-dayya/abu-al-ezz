...
export const translations = {
  en: {
    ...
    checkEmailReset: "If an account exists for that email, a password reset link has been sent.",
  ...
  ar: {
    ...
    checkEmailReset: "إذا كان هناك حساب مرتبط بهذا البريد، فقد تم إرسال رابط إعادة التعيين إليه.",
