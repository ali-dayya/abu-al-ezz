            ...
            <div className="space-y-3">
              {orders.map(order => (
                ...
                >
                  ...
                  <div
                    className={`flex items-center justify-between p-5 cursor-pointer transition-colors ${dir==="rtl"?"flex-row-reverse":""}`}
                  ...
                  >
                    <div className={`flex items-center gap-5 flex-wrap ${dir==="rtl"?"flex-row-reverse":""}`}>
                      <div>
                        ...
                        <p className="font-bold" style={{ color:"#1a1a1a" }}>#{order.order_id}</p>
                      </div>
                  ...
                  {expanded === order.order_id && (
                    <div style={{ borderTop:"1px solid #f0ece4", background:"#fdfaf3", padding:"20px" }}>
                      {order.notes && (
